...
`],encapsulation:2,changeDetection:0})}return n})();var ms=(()=>{class n{static \u0275fac=function(e){return new(e||n)};static \u0275mod=x({type:n});static \u0275inj=y({imports:[z]})}return n})();var Dc=n=>({"list-view":n});function Sc(n,i){n&1&&(u(0,"mat-icon",15),R(1,"search"),m())}function Ic(n,i){if(n&1){let t=xt();u(0,"button",16),F("click",function(){X(t);let o=A();return K(o.clearSearch())}),u(1,"mat-icon"),R(2,"close"),m()()}}function Ac(n,i){if(n&1){let t=xt();u(0,"app-bookmark-list",19),F("delete",function(o){X(t);let r=A(2);return K(r.delete(o))})("edit",function(o){X(t);let r=A(2);return K(r.openEdit(o))}),m()}if(n&2){let t=A().ngIf;w("bookmarks",t)}}function Fc(n,i){n&1&&(u(0,"p"),R(1,"No data found!"),m())}function Rc(n,i){if(n&1&&(Ke(0),u(1,"div",17)(2,"h2"),R(3,"Today"),m(),ot(4,Ac,1,1,"app-bookmark-list",18)(5,Fc,2,0,"p",11),m(),Ze()),n&2){let t=i.ngIf;p(4),w("ngIf",t.length),p(),w("ngIf",!t.length)}}function Oc(n,i){if(n&1){let t=xt();u(0,"app-bookmark-list",19),F("delete",function(o){X(t);let r=A(2);return K(r.delete(o))})("edit",function(o){X(t);let r=A(2);return K(r.openEdit(o))}),m()}if(n&2){let t=A().ngIf;w("bookmarks",t)}}function Tc(n,i){n&1&&(u(0,"p"),R(1,"No data found!"),m())}function Pc(n,i){if(n&1&&(Ke(0),u(1,"div",17)(2,"h2"),R(3,"Yesterday"),m(),ot(4,Oc,1,1,"app-bookmark-list",18)(5,Tc,2,0,"p",11),m(),Ze()),n&2){let t=i.ngIf;p(4),w("ngIf",t.length),p(),w("ngIf",!t.length)}}function Vc(n,i){if(n&1){let t=xt();u(0,"app-bookmark-list",19),F("delete",function(o){X(t);let r=A(2);return K(r.delete(o))})("edit",function(o){X(t);let r=A(2);return K(r.openEdit(o))}),m()}if(n&2){let t=A().ngIf;w("bookmarks",t)}}function Nc(n,i){n&1&&(u(0,"p"),R(1,"No data found!"),m())}function Lc(n,i){if(n&1&&(Ke(0),u(1,"div",17)(2,"h2"),R(3,"Older"),m(),ot(4,Vc,1,1,"app-bookmark-list",18)(5,Nc,2,0,"p",11),m(),Ze()),n&2){let t=i.ngIf;p(4),w("ngIf",t.length),p(),w("ngIf",!t.length)}}function Bc(n,i){if(n&1){let t=xt();u(0,"div",20),F("click",function(){X(t);let o=A();return K(o.closePanel())}),m()}}var us=class n{searchTerm="";store=s($o);constructor(){}ngOnInit(){this.store.dispatch(Ko())}onSearchChange(i){this.store.dispatch(sn({term:i}))}today$=this.store.select(cn);yesterday$=this.store.select(dn);older$=this.store.select(tr);loading$=this.store.select(Jo);isSelected=!1;view="view_list";clearSearch(){this.searchTerm="",this.store.dispatch(sn({term:""}))}toggleView(){this.isSelected=!this.isSelected,this.view=this.isSelected?"view_module":"view_list"}add(i){this.store.dispatch(an({bookmark:i}))}delete(i){this.store.dispatch(Zo({id:i}))}isOpen=!1;selectedBookmark=null;openPanel(){this.selectedBookmark=null,this.isOpen=!0}openEdit(i){this.selectedBookmark=i,this.isOpen=!0}closePanel(){this.isOpen=!1}handleSave(i){i.id?this.store.dispatch(Qo({bookmark:i})):this.store.dispatch(an({bookmark:i})),this.closePanel()}static \u0275fac=function(t){return new(t||n)};static \u0275cmp=k({type:n,selectors:[["app-bookmark-pages"]],decls:26,vars:20,consts:[["color","primary",1,"bookmark-header"],[1,"logo"],[1,"title"],[1,"search"],["subscriptSizing","dynamic"],["matInput","","placeholder","Search bookmarks",3,"ngModelChange","ngModel"],["matSuffix","",4,"ngIf"],["mat-icon-button","","matSuffix","",3,"click",4,"ngIf"],[1,"bookmark-header_right","add-action"],[3,"click"],[1,"bookmark-container",3,"ngClass"],[4,"ngIf"],["class","overlay",3,"click",4,"ngIf"],[1,"side-panel"],[3,"save","bookmark"],["matSuffix",""],["mat-icon-button","","matSuffix","",3,"click"],[1,"lists"],[3,"bookmarks","delete","edit",4,"ngIf"],[3,"delete","edit","bookmarks"],[1,"overlay",3,"click"]],template:function(t,e){t&1&&(u(0,"mat-toolbar",0)(1,"div",1)(2,"mat-icon"),R(3,"bookmark"),m(),u(4,"span",2),R(5,"Bookmarker"),m()(),u(6,"div",3)(7,"mat-form-field",4)(8,"input",5),F("ngModelChange",function(r){return e.onSearchChange(r)}),Ro("ngModelChange",function(r){return Fo(e.searchTerm,r)||(e.searchTerm=r),r}),m(),ot(9,Sc,2,0,"mat-icon",6)(10,Ic,3,0,"button",7),m()(),u(11,"div",8)(12,"mat-icon",9),F("click",function(){return e.toggleView()}),R(13),m(),u(14,"mat-icon",9),F("click",function(){return e.openPanel()}),R(15,"add"),m()()(),u(16,"section",10),ot(17,Rc,6,2,"ng-container",11),Qe(18,"async"),ot(19,Pc,6,2,"ng-container",11),Qe(20,"async"),ot(21,Lc,6,2,"ng-container",11),Qe(22,"async"),m(),ot(23,Bc,1,0,"div",12),u(24,"div",13)(25,"app-bookmark-form",14),F("save",function(r){return e.handleSave(r)}),m()()),t&2&&(p(8),Ao("ngModel",e.searchTerm),p(),w("ngIf",!e.searchTerm),p(),w("ngIf",e.searchTerm),p(3),Dt(e.view),p(3),w("ngClass",Oo(18,Dc,e.isSelected)),p(),w("ngIf",Je(18,12,e.today$)),p(2),w("ngIf",Je(20,14,e.yesterday$)),p(2),w("ngIf",Je(22,16,e.older$)),p(2),w("ngIf",e.isOpen),p(),S("open",e.isOpen),p(),w("bookmark",e.selectedBookmark))},dependencies:[te,Bo,jo,ki,Xi,$i,qi,_e,no,ii,cs,si,ai,Ui,Jn,Va,ge,Bi,$n,ms,ds,qo,Uo],styles:[".bookmark-header[_ngcontent-%COMP%]{display:grid;align-items:center;justify-content:space-between;margin-bottom:20px;background:#324c8c;grid-template-columns:1fr 2fr 1fr}@media(max-width:600px){.bookmark-header[_ngcontent-%COMP%]{grid-template-columns:1fr 6fr 1fr!important}}.bookmark-header[_ngcontent-%COMP%]   div[_ngcontent-%COMP%]{display:flex;align-items:center;gap:10px}.bookmark-header[_ngcontent-%COMP%]   .logo[_ngcontent-%COMP%]{justify-content:start;color:#fff}.bookmark-header[_ngcontent-%COMP%]   .logo[_ngcontent-%COMP%]   .title[_ngcontent-%COMP%]{font-size:20px;font-weight:500;font-family:Quicksand,sans-serif}@media(max-width:600px){.bookmark-header[_ngcontent-%COMP%]   .logo[_ngcontent-%COMP%]   .title[_ngcontent-%COMP%]{display:none}}.bookmark-header[_ngcontent-%COMP%]   .search[_ngcontent-%COMP%]{justify-content:center}.bookmark-header[_ngcontent-%COMP%]   .search[_ngcontent-%COMP%]     .mat-mdc-form-field{width:75%}@media(max-width:600px){.bookmark-header[_ngcontent-%COMP%]   .search[_ngcontent-%COMP%]     .mat-mdc-form-field{width:100%}}.bookmark-header[_ngcontent-%COMP%]   .search[_ngcontent-%COMP%]     .mat-mdc-form-field .mat-mdc-text-field-wrapper{background:none;padding:0}.bookmark-header[_ngcontent-%COMP%]   .search[_ngcontent-%COMP%]     .mat-mdc-form-field .mat-mdc-text-field-wrapper input{color:#fff;padding-left:15px}.bookmark-header[_ngcontent-%COMP%]   .search[_ngcontent-%COMP%]     .mat-mdc-form-field .mat-mdc-text-field-wrapper input::placeholder{color:#ffffff8a}.bookmark-header[_ngcontent-%COMP%]   .search[_ngcontent-%COMP%]     .mat-mdc-form-field .mat-mdc-text-field-wrapper .mat-icon{color:#fff}.bookmark-header[_ngcontent-%COMP%]   .add-action[_ngcontent-%COMP%]{cursor:pointer;justify-content:end}.bookmark-header[_ngcontent-%COMP%]   .add-action[_ngcontent-%COMP%]   .mat-icon[_ngcontent-%COMP%]{color:#fff;border:1px solid #fff;border-radius:3px;padding:2px}.bookmark-container[_ngcontent-%COMP%]{display:grid;margin:0 auto;max-width:1200px;width:100%}.bookmark-container.list-view[_ngcontent-%COMP%]   app-bookmark-list[_ngcontent-%COMP%]{display:flex;flex-direction:column}.bookmark-container[_ngcontent-%COMP%]   app-bookmark-list[_ngcontent-%COMP%]{display:grid;grid-template-columns:repeat(auto-fill,minmax(250px,1fr));gap:16px}.bookmark-container[_ngcontent-%COMP%]   .lists[_ngcontent-%COMP%]{border:#ccc 1px solid;border-radius:5px;padding:15px;margin:15px 0 0;box-sizing:border-box}.bookmark-container[_ngcontent-%COMP%]   .lists[_ngcontent-%COMP%]   h2[_ngcontent-%COMP%]{margin:0 0 15px}.overlay[_ngcontent-%COMP%]{position:fixed;top:0;left:0;width:100%;height:100%;background:#0000004d;z-index:100}.side-panel[_ngcontent-%COMP%]{position:fixed;top:65px;right:-440px;width:400px;height:100%;background:#fff;box-shadow:-2px 0 10px #0003;transition:right .3s ease;z-index:101;padding:20px;box-sizing:border-box}.side-panel.open[_ngcontent-%COMP%]{right:0}@media(max-width:600px){.side-panel[_ngcontent-%COMP%]{top:56px;width:265px}}@media(max-width:600px){  .mat-mdc-form-field-infix{width:auto!important}}"]})};export{us as BookmarkPagesComponent};
