import{e as $o,f as St,g as Xo,l as Ko,o as an,r as Zo,u as Qo,x as sn}from"./chunk-TR45T5VB.js";import{$ as O,$a as $,Aa as wo,Ab as Vo,Ba as k,C as Ji,Ca as x,Cb as Mt,Da as g,Db as j,Ea as q,Eb as on,F as go,Fa as ot,Fb as No,G as tn,Ga as Mo,Gb as ti,H as _o,Ha as xe,Hb as rn,I as Nt,Ia as Eo,Ib as Lo,J as Ye,Ja as zt,Jb as Bo,K as Et,Ka as Z,Kb as zo,L as Kt,La as Q,Lb as jo,Ma as J,Mb as Ho,N as qe,Na as w,Nb as Uo,O as Rt,Oa as u,Ob as te,P as v,Pa as m,Pb as Wo,Q as y,Qa as at,R as f,Ra as _t,Rb as Go,S as ve,Sa as bt,T as s,Ta as yt,Tb as Yo,Ua as Ke,Va as Ze,W as Zt,Wa as xt,Wb as qo,X,Xa as jt,Y as K,Ya as F,Z as en,Za as ko,_ as Y,_a as A,a as _,ab as D,b as tt,ba as B,bb as Ht,c as rt,ca as M,cb as Ut,d as Ue,da as $e,db as V,e as C,eb as N,f as lo,fa as et,fb as Do,ga as Lt,gb as So,h as co,hb as nn,ia as gt,ib as Ce,j as mo,ja as Bt,jb as S,k as lt,ka as E,kb as kt,l as uo,la as Qt,lb as R,m as mt,ma as vo,mb as Dt,na as bo,nb as Io,o as We,oa as Xe,ob as Ao,p as Xt,pa as yo,pb as Fo,q as ut,qa as Jt,qb as Ro,r as Zi,ra as xo,rb as nt,s as ho,sa as p,sb as Oo,t as po,ta as Ot,tb as Qe,u as Ge,ua as be,ub as Je,va as ct,vb as To,wa as it,wb as Ct,x as Qi,xa as T,xb as wt,ya as Co,yb as Po,z as fo,za as ye,zb as we}from"./chunk-UUWTD3SA.js";var ei=Xo("bookmarks"),hs=St(ei,n=>n.bookmarks),Jo=St(ei,n=>n.loading),jc=St(ei,n=>n.error),ps=St(ei,n=>n.search),ln=St(hs,ps,(n,i)=>{if(!i)return n;let t=i.toLowerCase();return n.filter(e=>e.title.toLowerCase().includes(t)||e.url.toLowerCase().includes(t))}),cn=St(ln,n=>{let i=new Date().toDateString();return n.filter(t=>new Date(t.createdAt).toDateString()===i)}),dn=St(ln,n=>{let i=new Date;i.setDate(i.getDate()-1);let t=i.toDateString();return n.filter(e=>new Date(e.createdAt).toDateString()===t)}),tr=St(ln,cn,dn,(n,i,t)=>n.filter(e=>!i.includes(e)&&!t.includes(e)));var fs=new f("cdk-dir-doc",{providedIn:"root",factory:()=>s(O)}),gs=/^(ar|ckb|dv|he|iw|fa|nqo|ps|sd|ug|ur|yi|.*[-_](Adlm|Arab|Hebr|Nkoo|Rohg|Thaa))(?!.*[-_](Latn|Cyrl)($|-|_))($|-|_)/i;function er(n){let i=n?.toLowerCase()||"";return i==="auto"&&typeof navigator<"u"&&navigator?.language?gs.test(navigator.language)?"rtl":"ltr":i==="rtl"?"rtl":"ltr"}var Tt=(()=>{class n{get value(){return this.valueSignal()}valueSignal=et("ltr");change=new B;constructor(){let t=s(fs,{optional:!0});if(t){let e=t.body?t.body.dir:null,o=t.documentElement?t.documentElement.dir:null;this.valueSignal.set(er(e||o||"ltr"))}}ngOnDestroy(){this.change.complete()}static \u0275fac=function(e){return new(e||n)};static \u0275prov=v({token:n,factory:n.\u0275fac,providedIn:"root"})}return n})();var z=(()=>{class n{static \u0275fac=function(e){return new(e||n)};static \u0275mod=x({type:n});static \u0275inj=y({})}return n})();var _s=["*"];var vs=[[["","mat-card-avatar",""],["","matCardAvatar",""]],[["mat-card-title"],["mat-card-subtitle"],["","mat-card-title",""],["","mat-card-subtitle",""],["","matCardTitle",""],["","matCardSubtitle",""]],"*"],bs=["[mat-card-avatar], [matCardAvatar]",`mat-card-title, mat-card-subtitle,
      [mat-card-title], [mat-card-subtitle],
      [matCardTitle], [matCardSubtitle]`,"*"],ys=new f("MAT_CARD_CONFIG"),ir=(()=>{class n{appearance;constructor(){let t=s(ys,{optional:!0});this.appearance=t?.appearance||"raised"}static \u0275fac=function(e){return new(e||n)};static \u0275cmp=k({type:n,selectors:[["mat-card"]],hostAttrs:[1,"mat-mdc-card","mdc-card"],hostVars:8,hostBindings:function(e,o){e&2&&S("mat-mdc-card-outlined",o.appearance==="outlined")("mdc-card--outlined",o.appearance==="outlined")("mat-mdc-card-filled",o.appearance==="filled")("mdc-card--filled",o.appearance==="filled")},inputs:{appearance:"appearance"},exportAs:["matCard"],ngContentSelectors:_s,decls:1,vars:0,template:function(e,o){e&1&&($(),D(0))},styles:[`.mat-mdc-card {
  display: flex;
...
`],encapsulation:2,changeDetection:0})}return n})();var qt;function Dr(){if(qt==null){if(typeof document!="object"||!document||typeof Element!="function"||!Element)return qt=!1,qt;if(document.documentElement?.style&&"scrollBehavior"in document.documentElement.style)qt=!0;else{let n=Element.prototype.scrollTo;n?qt=!/\{\s*\[native code\]\s*\}/.test(n.toString()):qt=!1}}return qt}function wn(){return typeof __karma__<"u"&&!!__karma__||typeof jasmine<"u"&&!!jasmine||typeof jest<"u"&&!!jest||typeof Mocha<"u"&&!!Mocha}var re,Sr=["color","button","checkbox","date","datetime-local","email","file","hidden","image","month","number","password","radio","range","reset","search","submit","tel","text","time","url","week"];function Mn(){if(re)return re;if(typeof document!="object"||!document)return re=new Set(Sr),re;let n=document.createElement("input");return re=new Set(Sr.filter(i=>(n.setAttribute("type",i),n.type===i))),re}function H(n){return n==null?"":typeof n=="string"?n:`${n}px`}function ae(n){return n!=null&&`${n}`!="false"}var Ts=new f("MATERIAL_ANIMATIONS"),Ar=null;function Ps(){return s(Ts,{optional:!0})?.animationsDisabled||s(Xe,{optional:!0})==="NoopAnimations"?"di-disabled":(Ar??=s(bn).matchMedia("(prefers-reduced-motion)").matches,Ar?"reduced-motion":"enabled")}function vt(){return Ps()!=="enabled"}var ft=(function(n){return n[n.FADING_IN=0]="FADING_IN",n[n.VISIBLE=1]="VISIBLE",n[n.FADING_OUT=2]="FADING_OUT",n[n.HIDDEN=3]="HIDDEN",n})(ft||{}),En=class{_renderer;element;config;_animationForciblyDisabledThroughCss;state=ft.HIDDEN;constructor(i,t,e,o=!1){this._renderer=i,this.element=t,this.config=e,this._animationForciblyDisabledThroughCss=o}fadeOut(){this._renderer.fadeOutRipple(this)}},Fr=ne({passive:!0,capture:!0}),kn=class{_events=new Map;addHandler(i,t,e,o){let r=this._events.get(t);if(r){let a=r.get(e);a?a.add(o):r.set(e,new Set([o]))}else this._events.set(t,new Map([[e,new Set([o])]])),i.runOutsideAngular(()=>{document.addEventListener(t,this._delegateEventHandler,Fr)})}removeHandler(i,t,e){let o=this._events.get(i);if(!o)return;let r=o.get(t);r&&(r.delete(e),r.size===0&&o.delete(t),o.size===0&&(this._events.delete(i),document.removeEventListener(i,this._delegateEventHandler,Fr)))}_delegateEventHandler=i=>{let t=st(i);t&&this._events.get(i.type)?.forEach((e,o)=>{(o===t||o.contains(t))&&e.forEach(r=>r.handleEvent(i))})}},Ie={enterDuration:225,exitDuration:150},Vs=800,Rr=ne({passive:!0,capture:!0}),Or=["mousedown","touchstart"],Tr=["mouseup","mouseleave","touchend","touchcancel"],Ns=(()=>{class n{static \u0275fac=function(e){return new(e||n)};static \u0275cmp=k({type:n,selectors:[["ng-component"]],hostAttrs:["mat-ripple-style-loader",""],decls:0,vars:0,template:function(e,o){},styles:[`.mat-ripple {
  overflow: hidden;
  position: relative;
}
...
`],encapsulation:2,changeDetection:0})}return n})();var Bl=["matButton",""],zl=[[["",8,"material-icons",3,"iconPositionEnd",""],["mat-icon",3,"iconPositionEnd",""],["","matButtonIcon","",3,"iconPositionEnd",""]],"*",[["","iconPositionEnd","",8,"material-icons"],["mat-icon","iconPositionEnd",""],["","matButtonIcon","","iconPositionEnd",""]]],jl=[".material-icons:not([iconPositionEnd]), mat-icon:not([iconPositionEnd]), [matButtonIcon]:not([iconPositionEnd])","*",".material-icons[iconPositionEnd], mat-icon[iconPositionEnd], [matButtonIcon][iconPositionEnd]"];var Ha=new Map([["text",["mat-mdc-button"]],["filled",["mdc-button--unelevated","mat-mdc-unelevated-button"]],["elevated",["mdc-button--raised","mat-mdc-raised-button"]],["outlined",["mdc-button--outlined","mat-mdc-outlined-button"]],["tonal",["mat-tonal-button"]]]),Ua=(()=>{class n extends Qn{get appearance(){return this._appearance}set appearance(t){this.setAppearance(t||this._config?.defaultAppearance||"text")}_appearance=null;constructor(){super();let t=Hl(this._elementRef.nativeElement);t&&this.setAppearance(t)}setAppearance(t){if(t===this._appearance)return;let e=this._elementRef.nativeElement.classList,o=this._appearance?Ha.get(this._appearance):null,r=Ha.get(t);o&&e.remove(...o),e.add(...r),this._appearance=t}static \u0275fac=function(e){return new(e||n)};static \u0275cmp=k({type:n,selectors:[["button","matButton",""],["a","matButton",""],["button","mat-button",""],["button","mat-raised-button",""],["button","mat-flat-button",""],["button","mat-stroked-button",""],["a","mat-button",""],["a","mat-raised-button",""],["a","mat-flat-button",""],["a","mat-stroked-button",""]],hostAttrs:[1,"mdc-button"],inputs:{appearance:[0,"matButton","appearance"]},exportAs:["matButton","matAnchor"],features:[q],attrs:Bl,ngContentSelectors:jl,decls:7,vars:4,consts:[[1,"mat-mdc-button-persistent-ripple"],[1,"mdc-button__label"],[1,"mat-focus-indicator"],[1,"mat-mdc-button-touch-target"]],template:function(e,o){e&1&&($(zl),yt(0,"span",0),D(1),_t(2,"span",1),D(3,1),bt(),D(4,2),yt(5,"span",2)(6,"span",3)),e&2&&S("mdc-button__ripple",!o._isFab)("mdc-fab__ripple",o._isFab)},styles:[`.mat-mdc-button-base {
  text-decoration: none;
}
...
`],encapsulation:2,changeDetection:0})}return n})();var He=(()=>{class n{static \u0275fac=function(e){return new(e||n)};static \u0275mod=x({type:n});static \u0275inj=y({imports:[Mr,_e,z]})}return n})();var vc=(()=>{class n{static \u0275fac=function(e){return new(e||n)};static \u0275cmp=k({type:n,selectors:[["ng-component"]],hostAttrs:["cdk-text-field-style-loader",""],decls:0,vars:0,template:function(e,o){},styles:[`textarea.cdk-textarea-autosize {
  resize: none;
}
...
`],encapsulation:2,changeDetection:0})}return n})();var ms=(()=>{class n{static \u0275fac=function(e){return new(e||n)};static \u0275mod=x({type:n});static \u0275inj=y({imports:[z]})}return n})();var Dc=n=>({"list-view":n});function Sc(n,i){n&1&&(u(0,"mat-icon",16),R(1,"search"),m())}function Ic(n,i){if(n&1){let t=xt();u(0,"button",17),F("click",function(){X(t);let o=A();return K(o.clearSearch())}),u(1,"mat-icon"),R(2,"close"),m()()}}function Ac(n,i){if(n&1){let t=xt();u(0,"app-bookmark-list",20),F("delete",function(o){X(t);let r=A(2);return K(r.delete(o))})("edit",function(o){X(t);let r=A(2);return K(r.openEdit(o))}),m()}if(n&2){let t=A().ngIf;w("bookmarks",t)}}function Fc(n,i){n&1&&(u(0,"p"),R(1,"No data found!"),m())}function Rc(n,i){if(n&1&&(Ke(0),u(1,"div",18)(2,"h2"),R(3,"Today"),m(),ot(4,Ac,1,1,"app-bookmark-list",19)(5,Fc,2,0,"p",12),m(),Ze()),n&2){let t=i.ngIf;p(4),w("ngIf",t.length),p(),w("ngIf",!t.length)}}function Oc(n,i){if(n&1){let t=xt();u(0,"app-bookmark-list",20),F("delete",function(o){X(t);let r=A(2);return K(r.delete(o))})("edit",function(o){X(t);let r=A(2);return K(r.openEdit(o))}),m()}if(n&2){let t=A().ngIf;w("bookmarks",t)}}function Tc(n,i){n&1&&(u(0,"p"),R(1,"No data found!"),m())}function Pc(n,i){if(n&1&&(Ke(0),u(1,"div",18)(2,"h2"),R(3,"Yesterday"),m(),ot(4,Oc,1,1,"app-bookmark-list",19)(5,Tc,2,0,"p",12),m(),Ze()),n&2){let t=i.ngIf;p(4),w("ngIf",t.length),p(),w("ngIf",!t.length)}}function Vc(n,i){if(n&1){let t=xt();u(0,"app-bookmark-list",20),F("delete",function(o){X(t);let r=A(2);return K(r.delete(o))})("edit",function(o){X(t);let r=A(2);return K(r.openEdit(o))}),m()}if(n&2){let t=A().ngIf;w("bookmarks",t)}}function Nc(n,i){n&1&&(u(0,"p"),R(1,"No data found!"),m())}function Lc(n,i){if(n&1&&(Ke(0),u(1,"div",18)(2,"h2"),R(3,"Older"),m(),ot(4,Vc,1,1,"app-bookmark-list",19)(5,Nc,2,0,"p",12),m(),Ze()),n&2){let t=i.ngIf;p(4),w("ngIf",t.length),p(),w("ngIf",!t.length)}}function Bc(n,i){if(n&1){let t=xt();u(0,"div",21),F("click",function(){X(t);let o=A();return K(o.closePanel())}),m()}}var us=class n{searchTerm="";store=s($o);constructor(){}ngOnInit(){this.store.dispatch(Ko())}onSearchChange(i){this.store.dispatch(sn({term:i}))}today$=this.store.select(cn);yesterday$=this.store.select(dn);older$=this.store.select(tr);loading$=this.store.select(Jo);isSelected=!1;view="view_list";clearSearch(){this.searchTerm="",this.store.dispatch(sn({term:""}))}toggleView(){this.isSelected=!this.isSelected,this.view=this.isSelected?"view_module":"view_list"}add(i){this.store.dispatch(an({bookmark:i}))}delete(i){this.store.dispatch(Zo({id:i}))}isOpen=!1;selectedBookmark=null;openPanel(){this.selectedBookmark=null,this.isOpen=!0}openEdit(i){this.selectedBookmark=i,this.isOpen=!0}closePanel(){this.isOpen=!1}handleSave(i){i.id?this.store.dispatch(Qo({bookmark:i})):this.store.dispatch(an({bookmark:i})),this.closePanel()}static \u0275fac=function(t){return new(t||n)};static \u0275cmp=k({type:n,selectors:[["app-bookmark-pages"]],decls:28,vars:20,consts:[["color","primary",1,"bookmark-header"],[1,"logo"],[1,"title"],[1,"search"],["subscriptSizing","dynamic"],["matInput","","placeholder","Search bookmarks",3,"ngModelChange","ngModel"],["matSuffix","",4,"ngIf"],["mat-icon-button","","matSuffix","",3,"click",4,"ngIf"],[1,"bookmark-header_right","add-action"],[3,"click"],[1,"bookmark-container",3,"ngClass"],["href","/profile"],[4,"ngIf"],["class","overlay",3,"click",4,"ngIf"],[1,"side-panel"],[3,"save","bookmark"],["matSuffix",""],["mat-icon-button","","matSuffix","",3,"click"],[1,"lists"],[3,"bookmarks","delete","edit",4,"ngIf"],[3,"delete","edit","bookmarks"],[1,"overlay",3,"click"]],template:function(t,e){t&1&&(u(0,"mat-toolbar",0)(1,"div",1)(2,"mat-icon"),R(3,"bookmark"),m(),u(4,"span",2),R(5,"Bookmarker"),m()(),u(6,"div",3)(7,"mat-form-field",4)(8,"input",5),F("ngModelChange",function(r){return e.onSearchChange(r)}),Ro("ngModelChange",function(r){return Fo(e.searchTerm,r)||(e.searchTerm=r),r}),m(),ot(9,Sc,2,0,"mat-icon",6)(10,Ic,3,0,"button",7),m()(),u(11,"div",8)(12,"mat-icon",9),F("click",function(){return e.toggleView()}),R(13),m(),u(14,"mat-icon",9),F("click",function(){return e.openPanel()}),R(15,"add"),m()()(),u(16,"section",10)(17,"a",11),R(18,"Back"),m(),ot(19,Rc,6,2,"ng-container",12),Qe(20,"async"),ot(21,Pc,6,2,"ng-container",12),Qe(22,"async"),ot(23,Lc,6,2,"ng-container",12),Qe(24,"async"),m(),ot(25,Bc,1,0,"div",13),u(26,"div",14)(27,"app-bookmark-form",15),F("save",function(r){return e.handleSave(r)}),m()()),t&2&&(p(8),Ao("ngModel",e.searchTerm),p(),w("ngIf",!e.searchTerm),p(),w("ngIf",e.searchTerm),p(3),Dt(e.view),p(3),w("ngClass",Oo(18,Dc,e.isSelected)),p(3),w("ngIf",Je(20,12,e.today$)),p(2),w("ngIf",Je(22,14,e.yesterday$)),p(2),w("ngIf",Je(24,16,e.older$)),p(2),w("ngIf",e.isOpen),p(),S("open",e.isOpen),p(),w("bookmark",e.selectedBookmark))},dependencies:[te,Bo,jo,ki,Xi,$i,qi,_e,no,ii,cs,si,ai,Ui,Jn,Va,ge,Bi,$n,ms,ds,qo,Uo],styles:[".bookmark-header[_ngcontent-%COMP%]{display:grid;align-items:center;justify-content:space-between;margin-bottom:20px;background:#324c8c;grid-template-columns:1fr 2fr 1fr}@media(max-width:600px){.bookmark-header[_ngcontent-%COMP%]{grid-template-columns:1fr 6fr 1fr!important}}.bookmark-header[_ngcontent-%COMP%]   div[_ngcontent-%COMP%]{display:flex;align-items:center;gap:10px}.bookmark-header[_ngcontent-%COMP%]   .logo[_ngcontent-%COMP%]{justify-content:start;color:#fff}.bookmark-header[_ngcontent-%COMP%]   .logo[_ngcontent-%COMP%]   .title[_ngcontent-%COMP%]{font-size:20px;font-weight:500;font-family:Quicksand,sans-serif}@media(max-width:600px){.bookmark-header[_ngcontent-%COMP%]   .logo[_ngcontent-%COMP%]   .title[_ngcontent-%COMP%]{display:none}}.bookmark-header[_ngcontent-%COMP%]   .search[_ngcontent-%COMP%]{justify-content:center}.bookmark-header[_ngcontent-%COMP%]   .search[_ngcontent-%COMP%]     .mat-mdc-form-field{width:75%}@media(max-width:600px){.bookmark-header[_ngcontent-%COMP%]   .search[_ngcontent-%COMP%]     .mat-mdc-form-field{width:100%}}.bookmark-header[_ngcontent-%COMP%]   .search[_ngcontent-%COMP%]     .mat-mdc-form-field .mat-mdc-text-field-wrapper{background:none;padding:0}.bookmark-header[_ngcontent-%COMP%]   .search[_ngcontent-%COMP%]     .mat-mdc-form-field .mat-mdc-text-field-wrapper input{color:#fff;padding-left:15px}.bookmark-header[_ngcontent-%COMP%]   .search[_ngcontent-%COMP%]     .mat-mdc-form-field .mat-mdc-text-field-wrapper input::placeholder{color:#ffffff8a}.bookmark-header[_ngcontent-%COMP%]   .search[_ngcontent-%COMP%]     .mat-mdc-form-field .mat-mdc-text-field-wrapper .mat-icon{color:#fff}.bookmark-header[_ngcontent-%COMP%]   .add-action[_ngcontent-%COMP%]{cursor:pointer;justify-content:end}.bookmark-header[_ngcontent-%COMP%]   .add-action[_ngcontent-%COMP%]   .mat-icon[_ngcontent-%COMP%]{color:#fff;border:1px solid #fff;border-radius:3px;padding:2px}.bookmark-container[_ngcontent-%COMP%]{display:grid;margin:0 auto;max-width:1200px;width:100%}.bookmark-container.list-view[_ngcontent-%COMP%]   app-bookmark-list[_ngcontent-%COMP%]{display:flex;flex-direction:column}.bookmark-container[_ngcontent-%COMP%]   app-bookmark-list[_ngcontent-%COMP%]{display:grid;grid-template-columns:repeat(auto-fill,minmax(250px,1fr));gap:16px}.bookmark-container[_ngcontent-%COMP%]   .lists[_ngcontent-%COMP%]{border:#ccc 1px solid;border-radius:5px;padding:15px;margin:15px 0 0;box-sizing:border-box}.bookmark-container[_ngcontent-%COMP%]   .lists[_ngcontent-%COMP%]   h2[_ngcontent-%COMP%]{margin:0 0 15px}.overlay[_ngcontent-%COMP%]{position:fixed;top:0;left:0;width:100%;height:100%;background:#0000004d;z-index:100}.side-panel[_ngcontent-%COMP%]{position:fixed;top:65px;right:-440px;width:400px;height:100%;background:#fff;box-shadow:-2px 0 10px #0003;transition:right .3s ease;z-index:101;padding:20px;box-sizing:border-box}.side-panel.open[_ngcontent-%COMP%]{right:0}@media(max-width:600px){.side-panel[_ngcontent-%COMP%]{top:56px;width:265px}}@media(max-width:600px){  .mat-mdc-form-field-infix{width:auto!important}}"]})};export{us as BookmarkPagesComponent};
