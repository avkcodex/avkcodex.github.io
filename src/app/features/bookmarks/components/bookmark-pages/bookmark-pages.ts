...
import {selectLoading, selectOlder, selectToday, selectYesterday } from '../../store/bookmark.selector'
import { Store } from '@ngrx/store'
import { addBookmark, deleteBookmark, loadBookmarks, setSearch, updateBookmark } from '../../store/bookmark.action'
